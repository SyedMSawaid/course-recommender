        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreRequisitesId = table.Column<string>(type: "text", nullable: true),
                    PreRequisiteToId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PreRequisites", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PreRequisites_Courses_PreRequisitesId",
                        column: x => x.PreRequisitesId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PreRequisites_Courses_PreRequisiteToId",
                        column: x => x.PreRequisiteToId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PreRequisites_PreRequisitesId",
                table: "PreRequisites",
                column: "PreRequisitesId");

            migrationBuilder.CreateIndex(
                name: "IX_PreRequisites_PreRequisiteToId",
                table: "PreRequisites",
                column: "PreRequisiteToId");
